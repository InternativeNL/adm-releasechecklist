<?php
/*
Plugin Name: Internative Release Checklist
...
if ( is_admin() ){
    ...
    function adm_releasechecklist_menu() {
    	add_menu_page( 'Internative Checklist', 'Internative Checklist', 'update_core', 'adm-releasechecklist', 'adm_releasechecklist_options' );
    }
